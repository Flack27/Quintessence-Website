...
namespace QuintessenceWebsiteInterface.INTERFACE
{
    public interface IQuestionsDAL
    {
        ...
        public Task<bool> WillRequiredDependentQuestionsApply(long formId, long userId, long submissionId);
        ...
        public Task<List<QuestionsDTO>?> GetDependentQuestions(long formId, long userId, long submissionId);
